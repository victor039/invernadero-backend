...
ALTER TABLE ventas ADD COLUMN IF NOT EXISTS ticket_whatsapp BOOLEAN DEFAULT FALSE;
ALTER TABLE ventas ADD COLUMN IF NOT EXISTS ticket_correo BOOLEAN DEFAULT FALSE;
ALTER TABLE ventas ADD COLUMN IF NOT EXISTS telefono_ticket VARCHAR(255);
...
UPDATE ventas SET ticket_whatsapp = FALSE WHERE ticket_whatsapp IS NULL;
